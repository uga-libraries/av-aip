...
<xsl:stylesheet
	...
	<!--This stylesheet creates master.xml from MediaInfo XML output.-->
	...
	<!--QuickTime sometimes has a version value of 0. This does not have a real meaning and so is not included in the master.xml-->
